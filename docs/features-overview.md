...
本ドキュメントは、Loanpedia Batch Processing Systemの全機能を要件定義レベルで整理したものです。各機能の詳細仕様は、実装フェーズで `/speckit.specify` により作成されます。

プロダクトビジョンについては [vision.md](vision.md) を参照してください。
...
- [機能一覧と優先順位](#機能一覧と優先順位)
- [F01: データ収集・処理機能](#f01-データ収集処理機能)
- [F02: ユーザー管理機能](#f02-ユーザー管理機能)
- [F03: 検索・閲覧機能](#f03-検索閲覧機能)
- [F04: お気に入り機能](#f04-お気に入り機能)
- [技術スタック](#技術スタック)
- [機能間の依存関係](#機能間の依存関係)
