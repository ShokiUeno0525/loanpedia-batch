...
| P4 | F04 | ユーザー向け機能 | お気に入り、検索条件保存、履歴管理 | F02, F03 |
...
- **構造化データ生成**: Claude 3モデルでJSON形式に変換
...
- **AI API**: Amazon BedRock API（Claude 3モデル）
- **データベース**: MySQL 8.0+
- **実行頻度**: 月次バッチ処理
- **スクレイピングマナー**:
  - リクエスト間隔: 最低3秒
...
3. **F03**: メイン機能（ユーザーが最も使う機能）
4. **F04**: 付加価値機能（F03の利便性向上）
